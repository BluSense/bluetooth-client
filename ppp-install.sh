...
connect '/usr/sbin/chat -s -v -f /etc/chatscripts/quectel-chat-connect -T $1'
# The close script
disconnect '/usr/sbin/chat -s -v -f /etc/chatscripts/quectel-chat-disconnect'
...
echo "creating network interface configuration : /etc/network/interfaces.d/ppp-gprs"
echo "
auto ppp0
iface ppp0 inet ppp
        provider gprs
